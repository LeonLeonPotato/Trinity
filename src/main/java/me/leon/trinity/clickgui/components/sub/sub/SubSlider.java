...
public class SubSlider extends Component {
    ...
    public void render() {
        ...
        RenderUtils.drawRect((float) (this.parent.parent.parent.x + renderWidth + 7 + 4), this.parent.parent.parent.y + this.parent.parent.offset + this.parent.offset + this.offset + 14 + 14 + 14, this.parent.parent.parent.x + 7 + 4, this.parent.parent.parent.y + this.parent.parent.offset + this.parent.offset + this.offset + 14 + 14, new Color(0xA3959595, true));
        FontUtil.drawString(this.set.name + ": " + this.set.getValue(), this.parent.parent.parent.x + 7 + 6, this.parent.parent.parent.y + this.parent.parent.offset + this.offset + this.parent.offset + 14 + 14 + ((14 - FontUtil.getFontHeight())) / 2f, 0xa9b7c6);
    }
