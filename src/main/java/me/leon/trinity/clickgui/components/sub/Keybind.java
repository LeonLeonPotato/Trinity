...
public class Keybind extends Component {
    ...
    public void render() {
        ...
        FontUtil.drawString(this.binding ? "Listening" + determineDots(keyTimer) : "Key: " + Keyboard.getKeyName(mod.getKey()), this.parent.parent.x + 7, this.parent.parent.y + this.parent.offset + 14 + this.offset + ((14 - FontUtil.getFontHeight()) / 2f), ClickGUI.nameColorSetting.getValue().getRGB());
    }
