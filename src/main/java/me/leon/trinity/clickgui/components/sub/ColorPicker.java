...
public class ColorPicker extends Component {
    ...
    public void render() {
        ...
        if(this.open) {
            ...
            RenderUtils.drawRainbowRectVertical(this.parent.parent.x + 10, this.parent.parent.y + this.parent.offset + this.offset + 28, this.parent.parent.x + 8, 98, 3, 6, 200);
        }
    }
    ...
    public void updateComponent(int mouseX, int mouseY) {
        ...
        if(draggingAlpha) {
            this.renderAtAlpha = Math.min(67, Math.max(7, mouseX - (this.parent.parent.x + 8)));
        }
